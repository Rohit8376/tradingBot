...
const { genrateToeken, getProfile, getRMS, loginApi } = require('./login');
const { getOrderBook, getTradeBook, getLtp, placeOrder, modifyOrder, cancelOrder } = require('./orders');
const { genrateRule, modifyRule, getAll, getRuleById, cancelRule } = require('./TriggeredPrice');

 

// let smart_api = new SmartAPI({
//     api_key: "pOqUzX8V",    // PROVIDE YOUR API KEY HERE
...
// smart_api.generateSession( process.env.CLIENT_CODE, process.env.CLIENT_PASSWORD)
//     .then((data) => {
