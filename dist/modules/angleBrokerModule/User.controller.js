...
class UserController extends BaseController_1.BaseController {
    ...
    logout(req, res) {
        ...
        let method = "post";
        let url = "https://apiconnect.angelbroking.com/rest/secure/angelbroking/user/v1/logout";
        let Authorization = "Bearer eyJhbGciOiJIUzUxMiJ9.eyJ1c2VybmFtZSI6IlI0Nzc3NjkiLCJyb2xlcyI6MCwidXNlcnR5cGUiOiJVU0VSIiwiaWF0IjoxNjQ5NDA0MDQ3LCJleHAiOjE3MzU4MDQwNDd9.GDHA8__j73F8DuvLkYAeDxadmBbdUY5Egxy2yurfVVESXJ_1xgAhR8RuTD2NVENlIUgGpDs1labhpQDjkpxePg";
        const config = CommonUtils_1.CommonUtils.reqParamConfig(method, url, data, undefined, Authorization);
        (0, axios_1.default)(config)
            .then(function (response) {
    ...
    getRMS(req, res) {
        let method = "get";
        let url = "https://apiconnect.angelbroking.com/rest/secure/angelbroking/user/v1/getRMS";
        let Authorization = "Bearer eyJhbGciOiJIUzUxMiJ9.eyJ1c2VybmFtZSI6IlI0Nzc3NjkiLCJyb2xlcyI6MCwidXNlcnR5cGUiOiJVU0VSIiwiaWF0IjoxNjQ5NDA0MDQ3LCJleHAiOjE3MzU4MDQwNDd9.GDHA8__j73F8DuvLkYAeDxadmBbdUY5Egxy2yurfVVESXJ_1xgAhR8RuTD2NVENlIUgGpDs1labhpQDjkpxePg";
        const config = CommonUtils_1.CommonUtils.reqParamConfig(method, url, undefined, undefined, Authorization);
        (0, axios_1.default)(config)
            .then(function (response) {
            console.log(response.data);
        })
